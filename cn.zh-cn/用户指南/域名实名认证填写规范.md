...
>-   如果域名实名认证失败，请参考[域名实名认证失败如何处理？](https://support.huaweicloud.com/domain_faq/domain_faq_0001.html)
...
<td class="cellrowborder" valign="top" width="25.95259525952595%" headers="mcps1.2.4.1.2 "><a name="ul2346183114115"></a><a name="ul2346183114115"></a><ul id="ul2346183114115"><li>证件的彩色扫描件</li><li>证件的彩色数码照片</li></ul>
</td>
<td class="cellrowborder" valign="top" width="52.69526952695269%" headers="mcps1.2.4.1.3 "><a name="ul163614761910"></a><a name="ul163614761910"></a><ul id="ul163614761910"><li>必须为证件原件的竖屏、彩色电子版文件。</li><li>必须确保扫描件或照片无遮挡、无涂抹，无水印（ 含相机自带水印）。</li><li>必须包含证件边框、清晰完整的红色公章，不需要加盖公章。</li><li>必须保证国徽、颁证机关的公章为红色且清晰完整等元素清晰完整。</li></ul>
<div class="note" id="note184931677417"><a name="note184931677417"></a><a name="note184931677417"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p144941676415"><a name="p144941676415"></a><a name="p144941676415"></a>为了提高审核成功率及效率，建议您优先使用证件的彩色扫描件。</p>
</div></div>
</td>
</tr>
