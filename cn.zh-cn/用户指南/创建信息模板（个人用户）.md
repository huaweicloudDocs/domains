...
3.  在页面右上角，单击“创建信息模板”。
    ...
    **图 1**  创建信息模板<a name="fig2051919101335"></a>  
    ![](figures/创建信息模板.png "创建信息模板")

4.  根据实名认证证件内容填写“基本信息”区域，填写说明如[表1](#table111828581945)所示。

    **图 2**  信息模板基本信息<a name="fig66741136163313"></a>  
    ...
    **表 1**  基本信息填写说明
    ...
    <a name="ul19929049201411"></a><a name="ul19929049201411"></a><ul id="ul19929049201411"><li>支持输入1~64个字符，可以包含数字及英文字母。</li><li>可以使用.,、&middot;（）()《》\\-\"“”/'特殊字符。</li><li>必须包含中文，中间不允许输入空格。</li></ul>
    ...
    <td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><a name="ul116681532018"></a><a name="ul116681532018"></a><ul id="ul116681532018"><li>支持输入1~64个字符，可以包含数字及空格。</li><li>可以使用.&middot;,()\\-\"/'特殊字符，但不允许以特殊字符紧跟空格开头。</li><li>填写的内容不允许包含"《》"。</li></ul>
    ...
    <td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><a name="ul1345175217218"></a><a name="ul1345175217218"></a><ul id="ul1345175217218"><li>支持输入1~32个字符，可以包含数字及英文字母。</li><li>可以使用.,、&middot;（）()《》\\-\"“”/'特殊字符。</li><li>必须包含中文，中间不允许输入空格。</li></ul>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.2 "><div class="p" id="p11823142712361"><a name="p11823142712361"></a><a name="p11823142712361"></a>支持输入3~64个字符，可以包含数字及.,&middot;()-'\"/\\特殊字符。<div class="note" id="note20640156142412"><a name="note20640156142412"></a><a name="note20640156142412"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p764211568248"><a name="p764211568248"></a><a name="p764211568248"></a>若无英文名称，可使用系统自动填入的“联系人（中文）”的拼音。</p>
    </div></div>
    </div>
    </td>
    </tr>
...
5.  在“身份认证”区域，提交信息模板的实名认证材料。

    **图 3**  身份认证（个人用户）<a name="fig5797649125915"></a>  
    ![](figures/身份认证（个人用户）.png "身份认证（个人用户）")
